          ...
          <div class="p-5">
            <b-form>
              <div class="row">
                ...
                <div class="col-10">
                  <input type="text" v-model="chip_type.name" placeholder="Name" disabled>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-10">
                  <input type="text" v-model="chip_type.alias" placeholder="Alias" disabled>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-10">
                  <input type="number" v-model="chip_type.cost" placeholder="Cost" disabled>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-10">
                  <input type="number" v-model="chip_type.price" placeholder="Price" disabled>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-10">
                  <input type="number" v-model="chip_type.discount_percent" placeholder="Discount percent" disabled>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-10">
                  <input type="text" v-model="chip_type.create_date" placeholder="Name" disabled>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-10">
                  <input type="text" v-model="chip_type.update_date" placeholder="Name" disabled>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-10">
                  <b-form-checkbox v-model="chip_type.enabled" class="mt-auto mb-auto" switch size="lg" disabled></b-form-checkbox>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-10">
                  <b-form-checkbox v-model="chip_type.in_stock" class="mt-auto mb-auto" switch size="lg" disabled></b-form-checkbox>
                </div>
              </div>
          ...
          <div class="p-5">
            <b-form>
              <p class="p-3">Short description</p>
                {{ chip_type.short_description }}

              <p class="p-3">Full description</p>
                {{ chip_type.full_description }}
            </b-form>
          </div>
        </b-tab>
        ...
        <b-tab title="Details" lazy>
          <div class="p-5">
            <b-form>
              ...
              <div v-else>
                <div class="row details" v-for="detail in chip_type.chip_type_detail" :key="detail.name">
                  <div class="col-6">
          ...
          <div class="p-5">
            <b-form>
              <div class="row">
                ...
                <div class="col-10">
                  <input type="number" v-model="chip_type.weight" placeholder="Weight (Gm)" disabled>
                </div>
              </div>
