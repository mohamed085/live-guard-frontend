<template>
  <div class="main">
    <div class="header d-flex">
      <h2 class="heading-secondary">Add New Chip Version</h2>
    </div>
          ...
          <b-tab title="Overview" active>
            <div class="p-5">
              ...
              <div class="row mb-4">
                ...
                <div class="col-9">
                  <b-form-checkbox v-model="chip_type.reviewedByCustomer" class="mt-auto mb-auto" switch size="lg"></b-form-checkbox>
                </div>
              </div>
              <div class="row mb-4">
                <div class="col-3 label">
                ...
                <div class="col-9">
                  <b-form-checkbox v-model="chip_type.customerCanReview" class="mt-auto mb-auto" switch size="lg"></b-form-checkbox>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    async addNewChipType() {
      ...
      formdata.append("discount_percent", this.chip_type.discount_percent);
      formdata.append("reviewedByCustomer", this.chip_type.reviewedByCustomer);
      formdata.append("customerCanReview", this.chip_type.customerCanReview);
      ...
      let url = "http://localhost:8081/api/chip-versions";

      await fetch(url, requestOptions)
          .then(response => response.json())
          .then(result => {
            this.success = result
            router.push("/chip-versions")
          })
          .catch(error => {
