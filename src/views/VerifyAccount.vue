  ...
  <div>
    ...
    <header class="header">
      ...
      <div class="header__text-box">
        ...
        <b-form class="form" @submit.prevent="verifyAccount">
          <span class="heading-secondary">Verify Account</span>
          <p>Check your account for code</p>
          ...
          <div v-else>
            ...
            <div class="form__group">
              <input type="text" class="form__input" placeholder="Code" v-model="code" id="password" required>
            </div>


            <button class="btn btn--green mb-4">VERIFY ACCOUNT &rarr;</button>
            <br>
            <span @click="resendEmail" class="heading-tertiary">Resend email</span>
...
export default {
  ...
  methods: {
    async verifyAccount() {
      ...
      let url = "https://live-guard.herokuapp.com/api/auth/verify-account"
    ...
    async resendEmail() {
      ...
      if (this.email === null) {
        this.error = "You should insert email";
        this.isLoading = false;
      } else {
        this.error = '';
        let myHeaders = new Headers();
        ...
        let url = "https://live-guard.herokuapp.com/api/auth/resend-verify-mail"
