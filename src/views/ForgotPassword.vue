    ...
    <header class="header">
      ...
      <div class="header__text-box">
        ...
        <b-form class="form" @submit.prevent="forgotPassword">
          <span class="heading-secondary mb-5 mt-3">Enter your email</span>
          ...
          <div v-else>
            ...
            <button class="btn btn--green mb-5">Send reset password email &rarr;</button>
          </div>
        </b-form>
...
export default {
  ...
  methods: {
    async forgotPassword() {
      ...
      let url = "https://live-guard.herokuapp.com/api/auth/forgot-password"
