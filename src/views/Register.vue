    ...
    <header class="header">
      ...
      <div class="header__text-box">
        ...
        <b-form class="form" @submit.prevent="register">
          <span class="heading-secondary">Register</span>
          ...
          <div v-else>
            <div class="form__group">
              <input type="text" class="form__input" placeholder="Name" v-model="name" required>
            </div>
            <div class="form__group">
              <input type="email" class="form__input" placeholder="Email" v-model="email" required>
            </div>
            <div class="form__group">
            ...
            <div class="form__group">
              <input type="text" class="form__input" placeholder="Phone" v-model="phone" required>
            </div>

            <button class="btn btn--green mb-4">Register &rarr;</button>
...
export default {
  ...
  methods: {
    ...
    async register() {
      ...
      let url = "https://live-guard.herokuapp.com/api/auth/register"
